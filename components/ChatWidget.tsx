...
export const ChatWidget: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-36 right-4 z-50 w-80 h-96 bg-background-dark border border-white/10 rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-fade-in-up">
          <div className="p-4 bg-primary/10 border-b border-white/5 flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-text-secondary">Powered by Gemini 3 Flash</p>
            </div>
          </div>
          
          <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-[#0c0c16]">
